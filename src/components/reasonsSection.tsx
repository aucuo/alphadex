...
const ReasonsSection: React.FC = () => {
    ...
    const cards = [
        {
            title: 'Глубина',
            text: 'Вы получите не просто теорию - вы полностью\n' +
                'погрузитесь в мир мемкойнов',
            icon: R1Icon,
        },
        {
            title: 'Поддержка',
            text: 'Мы всегда на связи, готовы ответить на вопросы\n' +
        ...
        {
            title: 'Практика',
            text: 'мы передаем реальный рыночный опыт трейдинга,\n' +
                'что бы вы сразу могли применять полученные знания\n' +
                'и обмениваться опытом с участниками клуба',
            icon: R3Icon,
        },
        {
            title: 'ресурсы',
            text: 'вы получите доступ к подробным гайдам и материалам,\n' +
                'которые повысят ваш скилл в торговле',
            icon: R4Icon,
        },
        {
            title: 'THE ONE CLUB',
            text: 'Вы станете частью закрытого клуба трейдеров, в котором повысите свой скилл, получите доступ к сигналам и инсайдерской информации и всегда будете в тренде нарратива',
            icon: R5Icon,
        },
    ];
