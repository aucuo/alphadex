...
const ReasonsSection: React.FC = () => {
    ...
    const cards = [
        {
            title: 'Глубина',
            text: `Вы получите не просто теорию - вы<br/> полностью погрузитесь в мир мемкойнов`,
            icon: R1Icon,
        },
        {
            title: 'Поддержка',
            text: `Мы всегда на связи, готовы ответить на вопросы <br/>и поможем на каждом этапе вашего пути, <br/>обеспечивая уверенность и поддержку`,
            icon: R2Icon,
        },
        {
            title: 'Практика',
            text: `мы передаем реальный рыночный опыт трейдинга,<br/> что бы вы сразу могли применять полученные<br/> знания и обмениваться опытом с участниками клуба`,
            icon: R3Icon,
        },
        {
            title: 'ресурсы',
            text: `вы получите доступ к подробным<br/> гайдам и материалам, которые<br/> повысят ваш скилл в торговле`,
            icon: R4Icon,
        },
        {
            title: 'THE ONE CLUB',
            text: `Вы станете частью закрытого клуба трейдеров, в котором<br/> повысите свой скилл, получите доступ к сигналам и инсайдерской<br/> информации и всегда будете в тренде нарратива`,
            icon: R5Icon,
        },
    ];
